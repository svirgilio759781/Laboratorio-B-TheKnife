...
public class LoginView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        loginBtn.setOnMouseEntered(_ -> loginBtn.setStyle("-fx-background-color: #247a82;" + baseBtnStyle));
        loginBtn.setOnMouseExited(_ -> loginBtn.setStyle(tealBtnStyle));
